...
//		fr.close();// 关闭文件
	...
	public static boolean wirte(String filePath, List<String> dataList) {
		boolean flag=true;
		...
		try {
			...
			for (int i = 0; dataList != null && i < dataList.size(); i++) {
				buff.write((dataList.get(i)+enter).getBytes("UTF-8"));
			}
			buff.flush();
			buff.close();
		} catch (Exception e) {
	...
	public static boolean wirte(String filePath, String data) {
		boolean flag=true;
		FileOutputStream outSTr = null;
		BufferedOutputStream buff = null;
		String enter = "\r\n";
